export const routes = {
  ...
  generationImagesUrl: `${process.env.NEXT_PUBLIC_API_URL}/fs/images/gallery/generation/all`,
  projectsImagesUrl: `${process.env.NEXT_PUBLIC_API_URL}/fs/images/gallery/projects/all`
}
